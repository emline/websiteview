...
<div id="footer">
    <div id="table">
        ...
        <div id="tr" class="padding-all">
            ...
            <li><a href="http://latimes.com/" target="_blank">Los Angeles Times</a></li>
            <li><a href="http://nytimes.com" target="_blank">The New York Times</a></li>
            <li><a href="http://huggingtonpost.com/" target="_blank">The Huffington Post</a></li>
            <li><a href="http://latimes.com/" target="_blank">Los Angeles Times</a></li>
            <li><a href="http://latimes.com/" target="_blank">Los Angeles Times</a></li>
        </div>
        <div id="tr" class="padding-first">
            <h3 class="color">Recommended Links</h3>
            <li><a href="http://latimes.com/" target="_blank">Los Angeles Times</a></li>
            <li><a href="http://nytimes.com" target="_blank">The New York Times</a></li>
            <li><a href="http://huggingtonpost.com/" target="_blank">The Huffington Post</a></li>
